    ...
    <div className="group w-fit">
      <div className="relative grid h-64 w-64 grid-cols-2 grid-rows-2 overflow-hidden rounded fill-white">
        <Image
          src={profile_url}
          alt="profile"
          className="duration-350 object-cover absolute z-10 h-full w-full bg-white transition-all group-hover:-translate-x-16 group-hover:translate-y-16 group-hover:scale-50 filter grayscale-0 group-hover:grayscale"
          width={800}
          height={800}
        />
