        ...
        <article className="flex xl:flex-row flex-col gap-10 lg:mx-40 md:mx-24 mx-10 py-10 justify-between items-center ">
          <div className="space-y-5">
            ...
            <p className="xl:w-96">
              ...
              companies, and opportunities to collaborate on projects to develop
              skills. By highlighting these opportunities, we strive to empower
              individuals to take advantage of them and reach their full
              potential.
            </p>
          </div>
        ...
        <article className="flex xl:flex-row flex-col gap-10 lg:mx-40 md:mx-24 mx-10 py-10 justify-between items-center ">
          ...
          <div className="">
            ...
            <p className="xl:w-96 ">
              ...
              like-minded individuals. So, pursue your dreams and code robustly
